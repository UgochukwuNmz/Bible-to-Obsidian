...
def generate_breadcrumbs(book, chapter, max_chapters):
    """
    Generates breadcrumbs for chapter navigation.
    """
    prev = next = ""
    if chapter > 1:
        ...
        for chapter in range(1, max_chapters + 1):
            ...
            for element in chapter_data:
                if element["type"] == "subtitle":
                    ...
                    chapter_content.append(f"###### v{element['verse_number']}\n\n")
                    chapter_content.append(f"{element['text']} ^v{element['verse_number']}\n\n")

            chapter_content.append("--- \n\n" + generate_breadcrumbs(book, chapter, max_chapters))
